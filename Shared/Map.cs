...
namespace NoxShared
{
    public class Map
    {
        ...
        public static uint[] tilecolors = new uint[145] {
          0xFF5E250C,  // Mud = 0,
          0xFFC0C0C0,  // StoneLight = 1,
          0xFF664431,  // DirtCrackedLight = 2,
          0xFF69574D,  // CobbleDirt = 3,
          0xFFA27861,  // RedBrick6 = 4,
          0xFF59481E,  // DirtLight = 5,
          0xFFEE0012,  // Lava = 6,
          0xFF2A591E,  // Grass = 7,
          0xFF356F26,  // GrassSparse = 8,
          0xFF8AD0CE,  // Water = 9,
          0xFF85806E,  // CobblestoneGrayLight = 10,
          0xFF403D33,  // CobblestoneBlack = 11,
          0xFFC77E56,  // RedBrick = 12,
          0xFF45596B,  // BusyBlue = 13,
          0xFF115E7A,  // CrystalCyan = 14,
          0xFF476069,  // RockDark = 15,
          0xFF555274,  // TileDark = 16,
          0xFF878185,  // TileStarBlack = 17,
          0xFFC8911C,  // WoodLight = 18,
          0xFF7A2F0A,  // WoodDark = 19,
          0xFF5B86AA,  // CheckerFloor = 20,
          0xFF898879,  // IxBrickSmall = 21,
          0xFFEDDCA9,  // GalavaGateFacade = 22,
          0xFF8AA7B5,  // BlueBrick3 = 23,
          0xFFECDBA8,  // GalavaTowerFacade = 24,
          0xFF141414,  // Black = 25,
          0xFF4A5F69,  // Bluebrick5 = 26,
          0xFF542209,  // DirtDark = 27,
          0xFF426FE0,  // RugBlueNorm = 28,
          0xFF109432,  // RugGreen = 29,
          0xFFAE1212,  // RugRed = 30,
          0xFF7C9775,  // IxExteriorFacade = 31,
          0xFFA5937C,  // DunMirFacade = 32,
          0xFFBABAB9,  // IxBrickSmallRev = 33,
          0xFFDA8146,  // Redbrick3 = 34,
          0xFFB18669,  // Redbrick4 = 35,
          0xFFEC6C17,  // Redbrick5 = 36,
          0xFF7B91A5,  // Bluebrick6 = 37,
          0xFFA37985,  // RedBrickDesign = 38,
          0xFF9B4D27,  // BusyRed = 39,
          0xFF6B6B6B,  // CobblestoneGrayDark = 40,
          0xFF6B5840,  // DirtCrackedDark = 41,
          0xFF8A3405,  // CobblestoneRed = 42,
          0xFFA76A1C,  // RockRed = 43,
          0xFFA7491C,  // TileRed = 44,
          0xFFC8BBB4,  // WoodGray = 45,
          0xFFD8A96C,  // StoneRed = 46,
          0xFF9F6033,  // TileStarRed = 47,
          0xFF8E8B79,  // IxBrickFancy = 48,
          0xFF4750FF,  // CrystalBlue = 49,
          0xFFD35900,  // RugBrown = 50,
          0xFF645C44,  // RugTan = 51,
          0xFFD9DA8A,  // RugTanLightNorm = 52,
          0xFFC6940D,  // WoodLight2 = 53,
          0xFF743506,  // WoodDark2 = 54,
          0xFF9F8D7F,  // WoodGray2 = 55,
          0xFF708145,  // GrassNorm = 56,
          0xFF626142,  // GrassSparse2 = 57,
          0xFF6F9843,  // GrassDense = 58,
          0xFF8C8258,  // WeedsSparse = 59,
          0xFF8D8359,  // DirtLight2 = 60,
          0xFFB7AD85,  // DirtLighter = 61,
          0xFF615136,  // DirtDark2 = 62,
          0xFF774628,  // DirtRed = 63,
          0xFF5B8576,  // DirtBlue = 64,
          0xFFD0C36D,  // DirtSand = 65,
          0xFF816543,  // DirtHard = 66,
          0xFF796752,  // CobbleStone = 67,
          0xFF9D8D7B,  // CobbleStoneMossy = 68,
          0xFF817669,  // CobbleStoneWeedy = 69,
          0xFFC1B2A1,  // CobbleStoneWebs = 70,
          0xFF899E56,  // GrassNormYellow = 71,
          0xFF8D8869,  // GrassSparseYellow = 72,
          0xFFB9C67A,  // GrassDenseYellow = 73,
          0xFFADA677,  // CaveHardTan = 74,
          0xFF735B3C,  // CaveHardBrown = 75,
          0xFF452700,  // CaveHardDark = 76,
          0xFFC3F0F2,  // IceFloorDeepBlue = 77,
          0xFFC5A949,  // WoodSlatFloor = 78,
          0xFF9F8B43,  // WoodSlatFloorRIVETS = 79,
          0xFFC6B062,  // WoodSlatFloor2 = 80,
          0xFFA49563,  // WoodSlatFloorRIVETS2 = 81,
          0xFFA6D5DE,  // IceFloorRough = 82,
          0xFF93BBC2,  // IceFloorDark = 83,
          0xFFD9F5FA,  // IceFloorLight = 84,
          0xFF846825,  // WoodThinSlatDark = 85,
          0xFF755C20,  // WoodThinSlatDarkREV = 86,
          0xFF8B7D5A,  // WoodThinSlatLight = 87,
          0xFF756B52,  // WoodThinSlatLightREV = 88,
          0xFFA58E56,  // WoodThinSlatNorm = 89,
          0xFF8E7E59,  // WoodThinSlatNormREV = 90,
          0xFF59788E,  // RugBlueLight = 91,
          0xFF164668,  // RugBlueDark = 92,
          0xFFE1DA9F,  // RugTanLightLight = 93,
          0xFFC5BC6E,  // RugTanLightDark = 94,
          0xFF9C927C,  // BonesHeavy = 95,
          0xFFB8B09E,  // BonesLight = 96,
          0xFF677987,  // WornBlueBrick = 97,
          0xFFA5A793,  // RoughCobble = 98,
          0xFF8CA685,  // RoughCobbleWeedy = 99,
          0xFFA6B2A3,  // RoughCobbleWebby = 100,
          0xFF888274,  // BrokenCobbleDirt = 101,
          0xFF808874,  // BrokenCobbleDirtGrass = 102,
          0xFF7A8766,  // BrokenCobbleGrass = 103,
          0xFF999285,  // BrokenCobbleDirtWebs = 104,
          0xFF838A73,  // BrokenCobbleWeedy = 105,
          0xFFA59D8E,  // BrickLight = 106,
          0xFF6D5F53,  // VolcanicCraggy = 107,
          0xFF465466,  // BlueBrick7 = 108,
          0xFFFFFFFF,  // TransparentFloor = 109,
          0xFFCF9139,  // OakWoodFloor = 110,
          0xFFCD7E29,  // RedwoodFloor = 111,
          0xFF637446,  // GreenBrick = 112,
          0xFF053E65,  // WaterDeep = 113,
          0xFF714B28,  // DunMirBrick1 = 114,
          0xFF4F3721,  // ManaMineDirt = 115,
          0xFF67A899,  // WaterShallow = 116,
          0xFF50520D,  // SwampGrass = 117,
          0xFF3B7366,  // WaterSwampDeep = 118,
          0xFF1A6265,  // WaterSwampShallow = 119,
          0xFF536470,  // LOTDDark = 120,
          0xFF554959,  // LOTDBlackMarble = 121,
          0xFF68596E,  // LOTDPitted = 122,
          0xFF606060,  // IxTempleInteriorFacade = 123,
          0xFF918486,  // IxBrick = 124,
          0xFF938C8D,  // IxBrickRev = 125,
          0xFF564C41,  // LOTDDark2 = 126,
          0xFF43597E,  // LOTDTempleFacade = 127,
          0xFFB2A175,  // GalavaBrick = 128,
          0xFF968863,  // GalavaBrick2 = 129,
          0xFF695B42,  // GalavaBrick3 = 130,
          0xFF504727,  // CryptFloor = 131,
          0xFF516672,  // Bluebrick4 = 132,
          0xFF523D27,  // GalavaBrownMarble = 133,
          0xFF7B6248,  // DunMirBrick2 = 134,
          0xFF215549,  // WaterDeepNoTeleport = 135,
          0xFF6B978D,  // WaterNoTeleport = 136,
          0xFF53A794,  // WaterShallowNoTeleport = 137,
          0xFF3A7265,  // WaterSwampDeepNoTeleport = 138,
          0xFF106164,  // WaterSwampShallowNoTeleport = 139,
          0xFF928777,  // AncientRuinRough = 140,
          0xFFB4A690,  // AncientRuin = 141,
          0xFF7A746B,  // DungeonStoneDark = 142,
          0xFFBDB4A6,  // DungeonStoneLight = 143,
          0xFF868076   // DungeonStoneMuddy = 144,
        };
