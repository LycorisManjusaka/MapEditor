...
namespace NoxShared
{
    public class ThingDb : NoxDb
    {
        public enum TileId : byte
        {
            ...
            IceFloorDeepBlue = 77,
            WoodSlatFloor = 78,
            WoodSlatFloorRIVETS = 79,
            WoodSlatFloor2 = 80,
            WoodSlatFloorRIVETS2 = 81,
            IceFloorRough = 82,
            IceFloorDark = 83,
            IceFloorLight = 84,
            WoodThinSlatDark = 85,
            WoodThinSlatDarkREV = 86,
            WoodThinSlatLight = 87,
            WoodThinSlatLightREV = 88,
            WoodThinSlatNorm = 89,
            WoodThinSlatNormREV = 90,
            RugBlueLight = 91,
            RugBlueDark = 92,
            RugTanLightLight = 93,
            RugTanLightDark = 94,
            ...
            RoughCobble = 98,
            RoughCobbleWeedy = 99,
            RoughCobbleWebby = 100,
            BrokenCobbleDirt = 101,
            BrokenCobbleDirtGrass = 102,
            BrokenCobbleGrass = 103,
            BrokenCobbleDirtWebs = 104,
            BrokenCobbleWeedy = 105,
            BrickLight = 106,
            VolcanicCraggy = 107,
            BlueBrick7 = 108,
            TransparentFloor = 109,
            OakWoodFloor = 110,
            RedwoodFloor = 111,
            GreenBrick = 112,
            WaterDeep = 113,
            ...
            SwampGrass = 117,
            WaterSwampDeep = 118,
            WaterSwampShallow = 119,
            LOTDDark = 120,
            LOTDBlackMarble = 121,
            LOTDPitted = 122,
            IxTempleInteriorFacade = 123,
            IxBrick = 124,
            IxBrickRev = 125,
            LOTDDark2 = 126,
            LOTDTempleFacade = 127,
            GalavaBrick = 128,
            GalavaBrick2 = 129,
            GalavaBrick3 = 130,
            CryptFloor = 131,
            Bluebrick4 = 132,
            GalavaBrownMarble = 133,
            DunMirBrick2 = 134,
            WaterDeepNoTeleport = 135,
            WaterNoTeleport = 136,
            WaterShallowNoTeleport = 137,
            WaterSwampDeepNoTeleport = 138,
            WaterSwampShallowNoTeleport = 139,
            AncientRuinRough = 140,
            AncientRuin = 141,
            DungeonStoneDark = 142,
            DungeonStoneLight = 143,
            DungeonStoneMuddy = 144,
            Invalid = 255
        };
        ...
        public enum EdgeId : byte
        {
            ...
            BlendEdge = 16,
            DenseGrassEdge = 17,
            YellowDenseGrassEdge = 18,
            WoodSlatEdge = 19,
            WoodSlatEdgeRIVETS = 20,
            WoodSlatEdge2 = 21,
            WoodSlatEdgeRIVETS2 = 22,
            DirtRidge = 23,
            IceRidge = 24,
            BrickEdgeBrown = 25,
            CobbleStoneTrim = 26,
            LavaEdgeBrownDirt = 27,
            LavaEdgeBlackDirt = 28,
            ShallowWaterAndGrass = 29,
            SwampEdge = 30,
            MetalBlue = 31,
            MetalBrass = 32,
            MetalCopper = 33,
